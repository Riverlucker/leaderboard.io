...
export default function NewUserPage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <h1 className="text-3xl font-bold mb-8">Add New User / Player</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. tiger@woods.com"
              className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
            <p className="text-xs text-slate-500 mt-1">Required if the user needs to sign in.</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
            <p className="text-xs text-slate-500 mt-1">Leave empty to create a dummy/local-only player.</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. GC Gut Altentann"
              className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2 text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
